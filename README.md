...
#### 阅读管理页面优化 🎯
- ✅ 去掉顶部空行，5个TAB紧贴顶部，页面更紧凑
- ✅ 固定栏目箭头图标改为三角形（收起向右，展开向下）
- ✅ RSS源栏目新增左侧三角形图标，去掉右侧箭头
- ✅ 两个栏目标题栏增加渐变背景和阴影，层次感增强
- ✅ 保存提示改为3秒闪现，不再固定显示
- ✅ 移除底部"需点击保存按钮才生效"的固定提示文字
...
### v3.2.0 (2026-05-12)
- ✅ 阅读管理页面去除顶部空行，TAB紧贴顶部
- ✅ 固定栏目箭头改为三角形图标（收起向右，展开向下）
- ✅ RSS源栏目新增左侧三角形图标
- ✅ 标题栏增加渐变背景和阴影，增强立体感
- ✅ 保存提示改为3秒闪现消息
- ✅ 移除底部固定提示文字
